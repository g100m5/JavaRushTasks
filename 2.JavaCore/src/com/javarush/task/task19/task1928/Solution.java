...
public class Solution {
    ...
    public static void main(String... args) throws IOException {
        try (
                FileOutputStream outputStream = new FileOutputStream("/home/hostuser/heel666");
                InputStream is = Solution.class.getClassLoader().getResourceAsStream("/home/hostuser/hello.exs")
        ) {
